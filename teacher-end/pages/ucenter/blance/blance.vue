			...
			<view class="scrollView">
				<view class="head-read">
					<view class="flex">
						...
						<view class="flex-box">
							<view class="flex-box-text">用户名：{{ userData.name }}({{ userData.id }})</view>
							<view class="flex-box-text">手机号：{{ userData.phone }}</view>
							<view class="flex-box-text">积分：536.25</view>
						</view>
				...
				<view class="white-box">
					<view class="tx">
						...
						<view class="tx-grid" @click="navTo()"><span class="tx-grid-comm-sign">立即提现</span></view>
					</view>
