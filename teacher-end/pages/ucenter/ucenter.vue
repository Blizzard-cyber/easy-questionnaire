<template>
	<view class="center">
		...
		<view class="userInfo" @click.capture="toUserInfo" :style="{background: 'url('+imageURL+')'}">
	...
	export default {
			...
			return {
				...
				ucenterList: [
					[
						...
						{
							"title": "我的余额",
							"to": '/pages/ucenter/blance/blance',
							"event": 'getScore',
							"icon": "paperplane"
						}
						// #ifdef APP-PLUS
		...
		onLoad() {
			...
			this.ucenterList[this.ucenterList.length - 2].unshift({
				...
				rightText:'1.0.1' + '-' + this.appVersion.versionCode,
				event: 'checkVersion',
				icon: 'loop',
