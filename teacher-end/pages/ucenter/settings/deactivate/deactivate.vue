<template>
	<view class="content">
		<text class="words" space="emsp">
			一、注销是不可逆操作，注销后:\n 
				1.帐号将无法登录、无法找回。\n
				2.帐号所有信息都会清除(个人身份信息、账户信息等;发布的问卷、聊天信息、问卷数据等;交易信息等)，你
			的朋友将无法通过本应用帐号联系你，请自行备份相关
			信息和数据。\n
			
			二、重要提示\n
				1.封禁帐号(永久封禁、社交封禁、问卷发布权限封禁)不能申请注销。\n
				2.注销后，你的个人信息、三方帐号(微信、QQ、支付宝)、手机号等绑定关系将解除，解除后可以绑定到其他帐号。\n
				3.注销后，手机号可以注册新的帐号，新帐号不会存在之前帐号的任何信息(问卷信息，问卷数据，个人信息等)。\n
