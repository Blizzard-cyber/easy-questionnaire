                ...
                <Sider ref="side1" hide-trigger collapsible :collapsed-width="78" v-model="isCollapsed" style="background:#fff">
					<Menu ref="leftMenu" :accordion="true" @on-select="selectItem" :active-name="activName" @on-open-change="isCollapsed=false" theme="light" width="auto" :class="menuitemClasses" :open-names="openNames">
						...
						<Submenu name="1">
                            ...
                            <MenuItem name="1-1" to="/userList">教师用户列表</MenuItem>
                            <MenuItem name="1-2">学生用户列表</MenuItem>
                        </Submenu>
                        <Submenu name="2">
                            <template slot="title">
                            ...
                            <MenuItem name="2-1" to="/showList">已发布问卷列表</MenuItem>
                            <MenuItem name="2-2" to="/textList">问卷回收数据</MenuItem>
                            <MenuItem name="2-3" to="/download">数据分析结果</MenuItem>
                        </Submenu>
                        <Submenu name="3">
                            <template slot="title">
                            ...
                            <MenuItem name="3-1">用户积分信息</MenuItem>
                            <MenuItem name="3-2">用户提现审核</MenuItem>
                        </Submenu>
                        <Submenu name="4">
                            <template slot="title">
                                <Icon type="ios-analytics"></Icon>
                            ...
                            <MenuItem name="4-1" to="/css1">问卷数据分析</MenuItem>
                            <MenuItem name="4-2" to="/css2">用户数据分析</MenuItem>
                            <MenuItem name="4-3" to="/css3">用户行为分析</MenuItem>
                            <MenuItem name="4-4" to="/css4">用户反馈信息</MenuItem>
                        </Submenu>
                         <Submenu name="5">
                            <template slot="title">
                                <Icon type="ios-analytics"></Icon>
                            ...
                            <MenuItem name="4-1" to="/css5">版本管理</MenuItem>
                            <MenuItem name="4-2" to="/css6">权限分配</MenuItem>
                            <MenuItem name="4-3" to="/css7">菜单管理</MenuItem>
                            <MenuItem name="4-4" to="/css8">字典管理</MenuItem>
                            <MenuItem name="4-5" to="/css9">日志查询</MenuItem>
